        ...
        <div className="flex items-center gap-3">
          ...
          {!templateRestrictions.isPremium && (
            <div className="flex items-center gap-2">
              ...
              <button
                className="bg-coral hover:bg-orange-600 text-white px-4 py-1 rounded-full text-sm font-semibold transition-colors duration-200"
          ...
          {templateRestrictions.isPremium && (
            <div className="bg-coral/10 text-coral px-3 py-1 rounded-full text-sm font-semibold">
              Premium Plan
            </div>
          )}
        </div>
...
const ColorPalette = ({ colors, isSelected, onSelect }) => {
  return (
    <div
      className={`h-28 bg-coral/5 flex rounded-lg overflow-hidden border-2 ${isSelected ? "border-coral" : "border-none"
        }`}
    >
